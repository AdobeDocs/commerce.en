...
1. Your **[!UICONTROL PayPal Merchant ID]** and **[!UICONTROL PayPal Merchant Status]** values are automatically displayed once you visit the [!DNL Payment Services] dashboard for the first time.
