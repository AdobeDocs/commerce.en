...
This flow diagram shows the general process for onboarding [!DNL Payment Services] with an Adobe Commerce or Magento Open Source v2.4.0 to 2.4.6.

![Onboarding flow](assets/Adobe_Payments-Onboarding_Flow-Adobe_Commerce_or_Magento_Open_Source_2.4_2.4.6-1-V1.png){width="700" zoomable="yes"}
