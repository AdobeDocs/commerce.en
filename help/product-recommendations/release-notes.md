...
![New](../assets/new.svg) Updated the CDN URLs for the `recommendations-admin-ui`. Production: `https://recommendations-admin-ui.adobe.io` QA: `https://recommendations-admin-ui-qa.adobe.io`.
