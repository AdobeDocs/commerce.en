...
>[!NOTE]
>
>When using Product Recommendations through REST, the `alternateEnvironmentId` parameter can be used to specify other dataspaces. When using Product Recommendations through [GraphQL](https://developer.adobe.com/commerce/webapi/graphql/schema/recommendations/recommendations/), this parameter is not available.
