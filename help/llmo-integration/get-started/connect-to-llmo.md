...
In this article, you learn how to make your [!DNL Adobe Commerce] catalog available to LLM Optimizer.
...
1. Optional: Enter **[!UICONTROL Host Name]** with the hostname of your Commerce instance (for example, `www.example.com`) if the UI prompts for it separately from the URL.
...
- Verify that connected **sandbox** projects are not mixed with **production** Commerce data unless you intend that.
