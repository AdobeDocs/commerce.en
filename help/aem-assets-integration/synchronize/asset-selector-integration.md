...
The **AEM Asset Selector** is available when the IMS client ID for the AEM Assets project has been configured in the Commerce Admin and users have the required [permissions and IMS authentication](../get-started/permissions.md). See [Configure the AEM Asset Selector](#configure-the-aem-asset-selector-in-adobe-commerce).
...
1. Fill in the **[!UICONTROL IMS Client ID]** field. For the required permissions and how to obtain this ID, see [User permissions and IMS](../get-started/permissions.md).
