...
**jacket** ![Two-way selector](../../assets/two-way.png) coat
**pants** ![Two-way selector](../../assets/two-way.png) slacks ![Two-way selector](../../assets/two-way.png) trousers
...
**sweatshirt** ![One-way selector](../../assets/one-way.png) hoodie
**pants** ![One-way selector](../../assets/one-way.png) capris ![One-way selector](../../assets/one-way.png) calf-length-pants ![One-way selector](../../assets/one-way.png) peddle pushers

## Multi-word synonym behavior

For multi-word synonyms, [!DNL Adobe Commerce Optimizer] considers the synonym as a phrase. For example, if you create a two-way synonym **dining room table** ![Two-way selector](../../assets/two-way.png) **kitchen table** ![Two-way selector](../../assets/two-way.png) **dining table**, then [!DNL Adobe Commerce Optimizer] searches across all fields set to searchable for the occurrence of **dining room table** or **kitchen table** or **dining table**.
