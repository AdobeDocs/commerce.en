...
* **Configure [semantic search](../setup/semantic-search.md)** in [Settings](../settings.md) to define the product attributes to be used in semantic search and their priority. Semantic search uses AI to understand intent and natural language (ideal for descriptive and synonym-style queries).
