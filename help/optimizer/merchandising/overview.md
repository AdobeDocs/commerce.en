...
* **Configure [facets](./facets/overview.md), [merchandising rules](./rules/overview.md), [category merchandising](./rules/category-merch.md), and [synonyms](./synonyms/overview.md)** to guide shoppers toward the most relevant products with minimal friction.
