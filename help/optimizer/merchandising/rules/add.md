...
1. Click the **Merchandising rules** workspace.
...
- To ensure the intelligent ranking works correctly, make sure that the **Search Weight** for any product attributes that are used for search or filtering (facets) is `5` or less. To find this setting in the [!DNL Adobe Commerce Optimizer] Admin:
