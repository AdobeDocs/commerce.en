...
>
>Products must be indexed, visible, in stock, and meet all rule filters to be eligible for pinning. If a product does not appear in the preview/results for your rule, pinning it will have no effect.
