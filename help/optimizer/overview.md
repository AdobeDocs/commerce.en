---
title: What is [!DNL Adobe Commerce Optimizer]?
...
- **Catalog Protection** - Restricts a catalog view so only requests carrying a valid signed token can retrieve its data. See [Restricted access keys](setup/restricted-access-keys.md) for setup.
