...
- Improve product discovery relevance with ranking that prioritizes **exact and near matches** and same-field matches; see [Search matching and ranking](search-relevance-matching.md).
