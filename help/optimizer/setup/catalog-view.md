...
1. Click **[!UICONTROL Add]** to create the catalog view. ​
    ...
    If the **[!UICONTROL Add]** button is not active, ensure that the scope is properly added by placing your cursor in the Catalog sources field and  pressing **enter**. ​
