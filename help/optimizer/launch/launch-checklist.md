...
&#x25A2; Any [catalog view protected](../setup/private-catalog-view.md#protect-a-catalog-view) with Catalog Protection has an unexpired [restricted access key](../setup/restricted-access-keys.md) assigned, and an owner is identified for key rotation.
