...
Once installed and configured, the [!DNL Commerce Optimizer Salesforce Commerce Connector] provides comprehensive monitoring and management capabilities from the SFCC to ACO Sync Panel:
