...
| Storefront GenAI variations          | Allowance for text-based content generation | Based on GMV tier<p>Minimum allocation: 1K variations/month | Yes<p>Purchase Generative AI credits separately  |
