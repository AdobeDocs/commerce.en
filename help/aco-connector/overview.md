...
- **Catalog views and policies** — Define region-, brand-, or customer-specific subsets and access rules from the [!UICONTROL Store setup] menu. To restrict who can query a catalog view, see [Private catalog views](/help/optimizer/setup/private-catalog-view.md)
