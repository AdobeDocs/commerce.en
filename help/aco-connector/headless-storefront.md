...
description: Learn how to integrate a headless storefront with [!DNL Adobe Commerce Optimizer] using the [!DNL Adobe Commerce Optimizer Connector] GraphQL API and bundle product add-to-cart format.
