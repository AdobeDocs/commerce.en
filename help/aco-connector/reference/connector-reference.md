...
This reference lists the [!DNL Adobe Commerce Optimizer Connector] module packages, supported feed API endpoints, and configuration key paths stored in `core_config_data`. To learn how these components work together during synchronization, see [Data synchronization](../data-synchronization.md).
