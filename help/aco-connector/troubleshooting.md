...
description: "Learn how to diagnose and fix common [!DNL Adobe Commerce Optimizer] Connector issues, including credential failures, sync errors, and scope configuration problems."
...
- **400 errors** are not retried. Inspect the payload for malformed or missing required fields. See [Field Mappings](reference/field-mapping.md) for the expected format.
