...
>[!NOTE]
>
>Badges are intended to be mutually exclusive. That means that you won't see more than one page- or section-level badge on the same page or section. However, multiple inline badges are possible.
