...
If you have any documentation added to Cursor's context, you will need to disable it. Navigate to [!UICONTROL **Cursor**] > [!UICONTROL **Settings**] > [!UICONTROL **Cursor Settings**] > [!UICONTROL **Indexing & Docs**] and delete any documentation listed.
...
After verifying the generated code, you are ready to deploy the extension using the following prompt:
