...
description: Learn about the compliance and certifications for Adobe Commerce as a Cloud Service.
...
[!DNL Adobe Commerce as a Cloud Service] is built on a foundation of trust, transparency, and rigorous compliance with global security and privacy standards. Adobe's enterprise-grade security program ensures that [!DNL Adobe Commerce as a Cloud Service] meets the expectations of regulated industries and security-conscious organizations.

## Industry certifications

Adobe maintains a comprehensive set of certifications and attestations for the infrastructure and services that power [!DNL Adobe Commerce as a Cloud Service]. These include:
