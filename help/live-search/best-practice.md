...
- When you use intelligent ranking other than **None**, adjust **[Intelligent ranking boost](rules-add.md#intelligent-ranking-boost)** in the rule editor to balance popularity-style signals with textual relevance. Always confirm in **Test your rule** for the queries you care about.
