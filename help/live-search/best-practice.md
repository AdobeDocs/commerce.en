...
For how [!DNL Live Search] prioritizes **exact and near matches**, same-field matches, and broader cross-field matches (and how that interacts with search weights and rules), see [Search matching and ranking](search-relevance-matching.md).
