...
- [!DNL Live Search] does not support [search term redirects](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/catalog/search/search-terms) natively. Implement redirects via Fastly or another custom configuration.
