...
- Use the [GraphQL playground](https://experienceleague.adobe.com/en/docs/commerce/live-search/live-search-admin/graphql) with the default query (see [GraphQL reference](https://developer.adobe.com/commerce/services/graphql/live-search/) for more details) to verify the following:
...
- Review the [events](https://developer.adobe.com/commerce/services/shared-services/storefront-events/) that are required for [!DNL Live Search].
