...
![Fix](../assets/fix.svg) Fixed untracable "BulkException" in the cron.log which appeared in some cases when related to Catalog Data Exporter cron job failed <!--MDEE-966-->
