...
If your changes introduce new topics, significant updates, or corrections that need to be highlighted, you can add a short description to the [What's New section](https://experienceleague.adobe.com/en/docs/commerce/user-guides/home#whats-new) right from your pull request's body.
...
For examples, search in closed pull requests in the repository to see how existing highlights are formatted, and compare them with the [What's New section](https://experienceleague.adobe.com/en/docs/commerce/user-guides/home#whats-new) to see how they appear in the documentation.
